    ...
    <div className="fixed inset-x-0 bottom-0 z-50 border-t border-gray-200 bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.08)] md:hidden">
      <div className="flex h-16 items-stretch">
        ...
        <a
          ...
          className="flex flex-1 flex-col items-center justify-center gap-1 transition-colors active:bg-green-50"
          style={{ minHeight: "44px", color: "#25D366" }}
        >
          <svg
            className="h-5 w-5"
            viewBox="0 0 24 24"
        ...
        <a
          href={`/${locale}/book`}
          className="flex flex-1 flex-col items-center justify-center gap-1 bg-primary text-white transition-colors active:bg-primary-700"
          style={{ minHeight: "44px" }}
        >
